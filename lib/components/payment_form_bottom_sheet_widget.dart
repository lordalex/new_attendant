...
class PaymentFormBottomSheetWidget extends StatefulWidget {
  const PaymentFormBottomSheetWidget({
    super.key,
    this.value,
    this.ticketNumber,
  });
  ...
  @override
  State<PaymentFormBottomSheetWidget> createState() =>
      _PaymentFormBottomSheetWidgetState();
}

class _PaymentFormBottomSheetWidgetState
    extends State<PaymentFormBottomSheetWidget> {
  late PaymentFormBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentFormBottomSheetModel());
