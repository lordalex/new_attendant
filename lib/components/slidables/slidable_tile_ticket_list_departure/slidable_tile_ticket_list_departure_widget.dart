...
class SlidableTileTicketListDepartureWidget extends StatefulWidget {
  ...
  State<SlidableTileTicketListDepartureWidget> createState() =>
      _SlidableTileTicketListDepartureWidgetState();
}

class _SlidableTileTicketListDepartureWidgetState
    extends State<SlidableTileTicketListDepartureWidget>
    with TickerProviderStateMixin {
  late SlidableTileTicketListDepartureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SlidableTileTicketListDepartureModel());
