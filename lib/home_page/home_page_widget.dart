    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.instantTimer = InstantTimer.periodic(
        ...
        callback: (timer) async {
          if (_model.ticketlistArrival == ' 401') {
          ...
          _model.processigCounter =
              functions.jsontoArray(_model.ticketlistProcessingArrival!).length;
          _model.parkedCounter =
              functions.jsontoArray(_model.ticketlistParked!).length;
          _model.departureCounter =
              functions.jsontoArray(_model.ticketlistDeparture!).length;
          _model.completedCounter =
              functions.jsontoArray(_model.ticketlistCompleted!).length;
          _model.arrivalCounter =
              functions.jsontoArray(_model.ticketlistArrival!).length;
          _model.processingDepartureCounter = functions
              .jsontoArray(_model.ticketlistProcessingDeparture!)
              .length;
          safeSetState(() {});
          _model.isLoaded = true;
          _model.periodicHandler = _model.periodicHandler + 1;
          safeSetState(() {});
          if (_model.periodicHandler == 500) {
            _model.instantTimer?.cancel();
          }
        },
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 80.0, 0.0, 15.0),
                  child: ClipRRect(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  width: double.infinity,
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.091,
                                  decoration: BoxDecoration(
